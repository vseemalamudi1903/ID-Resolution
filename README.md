...
### Story-Driven Customer Journey Demo
This demonstration follows specific customer personas (Alice and Bob) as they move from anonymous visitors to loyalty members, showing real-time identity stitching and interest restoration.

1.  **Ensure the server is running** (`uvicorn app.main:app`).
2.  **Run the Story Demo**:
    ```bash
    python3 demo_customer_journey.py
    ```
    This script provides a narrated output of how different profiles are merged as new identifiers are introduced.
